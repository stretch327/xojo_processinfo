...
Protected Class ProcessInfo
	...
	#tag Structure, Name = NSOperatingSystemVersion, Flags = &h0
	...
	#tag Enum, Name = NSActivityOptions, Type = UInt64, Flags = &h0
		Background = 255
	...
	#tag Enum, Name = NSProcessInfoThermalState, Type = Integer, Flags = &h0
		NotSupported = -1
		  Nominal
		  Fair
		  Serious
